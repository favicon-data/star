...
import com.favicon.star.service.ScheduleService;
import com.favicon.star.service.SlackNotifier;
...
@Slf4j
@Configuration
public class SheduleCommandHanlder implements SlackCommandRegister{

    private final SlackNotifier notifier;
    private final ScheduleService scheduleService;

    public SheduleCommandHanlder(SlackNotifier notifier, ScheduleService scheduleService) {
